...
VeloGrid comes with a full set of keyboard shortcuts for desktop-class navigation. Every shortcut is **configurable** — you can override defaults, disable shortcuts, or define your own custom actions.
...
```typescript
import { DEFAULT_SHORTCUTS } from '@velosci-grid/core';
