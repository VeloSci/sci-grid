...
VeloGrid is 100% Canvas-based. While it provides standard renderers for text, numbers, and checkboxes, you might want to draw custom shapes, sparklines, or images.
