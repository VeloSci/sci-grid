...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/VeloSci/velosci-grid
...
Experience the speed of VeloGrid rendering **1,000,000 rows** without breaking a sweat.
...
| Feature | VeloGrid | AG Grid | TanStack Table |
|---------|---------|---------|----------------|
...
<footer class="landing-footer">
  <p>© 2026 VeloSci Instrumentation / Powered by VeloSci DNA</p>
</footer>
