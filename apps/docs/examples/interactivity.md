...
VeloGrid provides rich interactive features out of the box to feel like a native desktop application.
...
VeloGrid detects where you right-click and shows the appropriate menu:
...
VeloGrid's headers are "smart" and adapt their height based on the richness of information you provide.
