...
`velosci-grid` achieves massive virtualization by completely avoiding the `data={array}` pattern. If an array of 5 million rows was passed to React, diffing the Virtual DOM would freeze the browser.
