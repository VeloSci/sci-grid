...
This skill equips agents to integrate and extend **velosci-grid**, a sub-pixel precision Canvas-driven datagrid for massive datasets.
...
3. **Framework Wrappers**: The codebase provides `/react`, `/vue`, and `/solid`. Make sure to import the correct framework adapter rather than instantiating the Vanilla `VeloGrid` class inside a framework component.
